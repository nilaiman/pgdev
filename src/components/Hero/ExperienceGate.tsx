...
import { Bot, ArrowLeft, MonitorSmartphone, Settings, Languages, MessageSquareText, ChevronRight } from 'lucide-react'
...
function ExperienceGate() {
  ...
  // Controla rolagem do body quando o modal está aberto
  useEffect(() => {
    if (!selectedService) {
      ...
      <div className="experience-gate__modal">
        <div className="experience-gate__header">
          <div className="experience-gate__brand">
            <div className="experience-gate__bot-icon">
              <Bot size={20} />
            </div>
          ...
          {step === 1 ? (
            <>
              ...
              <div className="experience-gate__options">
                <button 
                  className="experience-gate__option"
                  onClick={() => {
                    setLanguage('pt')
                    setStep(2)
                  }}
            ...
            <>
              <button 
                className="experience-gate__back"
                onClick={() => setStep(1)}
              >
                <ArrowLeft size={16} />
                {isPt ? 'Voltar' : 'Volver'}
              ...
              <p className="experience-gate__subtitle">
                {isPt 
                  ...
                  : 'Elige una de las soluciones abajo'}
              </p>
